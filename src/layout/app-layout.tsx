...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['car-owner', 'administrator'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Booking', path: '/bookings', entity: 'booking', service: AccessServiceEnum.PROJECT, icon: FiCalendar },
    { name: 'Car', path: '/cars', entity: 'car', service: AccessServiceEnum.PROJECT, icon: FiBox },
